...
| Opzione | Default | Effetto |
|---------|---------|---------|
| `--region {US\|WORLD\|ALL}` | `WORLD` | WORLD: Xtrackers XDW*.MI 10 settori GICS, no real_estate (default, operativo retail BIt). US: SPDR XL* 11 settori (reference, lunga storia). ALL: unione |
